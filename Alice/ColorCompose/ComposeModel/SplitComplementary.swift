...
class SplitComplementaryModel: ComposeModel {
    
    let maxHueDistance: Int32 = 160
    let miniHueDistance: Int32 = 120
    ...
    override func reset(hue: Int32, saturation: Int32, brightness: Int32) -> ColorScheme {
        ...
        brightnesses[4] = difference(to: brightness, with: -10, in: 0...100)
    ...
    override func createHues(_ selector: Int, _ hue: Int32?) -> Array<Int32> {
        ...
        if (selector == 2) {
            hueDistance = ColorFunction.hueDistance(from: currentHues[1], to: currentHues[2], in: .clockwise)
            ...
            hues[4] = ColorFunction.hueRotate(from: hue, with: hueDistance, in: .clockwise)
        }
        else {
            ...
            hues[0] = ColorFunction.hueRotate(from: keyHue, with: hueDistance, in: .antiClockwise)
            ...
            hues[4] = ColorFunction.hueRotate(from: keyHue, with: hueDistance, in: .clockwise)
        }
